...
Avoid Unicode box-drawing for complex architecture diagrams; it breaks under wrapping, proportional fonts, and mixed-width characters.
If plain text art is explicitly needed, use a fenced code block, ASCII-only characters, short labels, fixed line widths, and verify every row has the same width.
